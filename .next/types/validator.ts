...
// Validate ../../src/app/test-subscription/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/test-subscription">> = Specific
  const handler = {} as typeof import("../../src/app/test-subscription/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
